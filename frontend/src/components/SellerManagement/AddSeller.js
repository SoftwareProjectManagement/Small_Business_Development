            ...
            <div className="col-12" style={{ marginTop: 20 }}>
              <div className="pb-2 px-3 d-flex flex-wrap align-items-center justify-content-between">
                <h2 style={{ fontSize: "26px" }}>
                  ...
                  <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Are
                  You Willing to Join With Us ?
                </h2>
                <p style={{ width: 800, fontSize: 18, marginLeft: 200 }}>
                  Simply fill the below form details to join with us and get
                  your products. Once you get the approval you will be add your
                  products into our platform and enhance your market place.
                </p>
              </div>
              <div
                style={{
          ...
          <div className="create_sub" style={{ marginLeft: 130, width: 880 }}>
            <form onSubmit={add} className="addsub">
              <div className="row">
                <div className="col-8">
                  <div className="row">
                    ...
                    <div>
                      ...
                      <label className="label1">Bussiness ID</label>
                      <br />
                      <div className="col-md-14 mb-4">
                        <div className="form-group3">
                          <OutlinedInput
                ...
                <br />
                <div
                  className="des checkboxcss"
                  style={{ position: "relative", top: 30, left: 32 }}
                >
                ...
                <div className="form-group5">
                  <input
                    className="btn addSellerSubmitBtn"
                    type="submit"
                    value="Submit"
                    style={{
                      padding: "5px 20px",
